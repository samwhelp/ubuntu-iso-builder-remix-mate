...
| `+` | `+` |
| [ubuntu-iso-builder-remix-mate](https://samwhelp.github.io/ubuntu-iso-builder-remix-mate/) | [GitHub](https://github.com/samwhelp/ubuntu-iso-builder-remix-mate) |
| `=` | `=` |
| [ubuntu-iso-builder-respin-mate](https://samwhelp.github.io/ubuntu-iso-builder-respin-mate/) | [GitHub](https://github.com/samwhelp/ubuntu-iso-builder-respin-mate) |
...
| Config |
| ------ |
| [~/.config](https://github.com/samwhelp/ubuntu-iso-builder-remix-mate/tree/main/profile/template/asset/overlay/etc/skel/.config) |
| [/usr/share/glib-2.0/schemas](https://github.com/samwhelp/ubuntu-iso-builder-remix-mate/tree/main/profile/template/asset/overlay/usr/share/glib-2.0/schemas) |
| [/etc/dconf/db/distro.d](https://github.com/samwhelp/ubuntu-iso-builder-remix-mate/tree/main/profile/template/asset/overlay/etc/dconf/db/distro.d) |
...
> clone [ubuntu-iso-builder-remix-mate](https://github.com/samwhelp/ubuntu-iso-builder-remix-mate)

``` sh
git clone https://github.com/samwhelp/ubuntu-iso-builder-remix-mate.git
```


> change dir to `ubuntu-iso-builder-remix-mate`

``` sh
cd ubuntu-iso-builder-remix-mate
```
...
> change dir to `~/work/ubuntu-iso-builder-remix-mate/iso-profile`

``` sh
cd ~/work/ubuntu-iso-builder-remix-mate/iso-profile
```
...
> The resulting ISO file will be placed on `~/work/ubuntu-iso-builder-remix-mate/iso-profile/dist`
